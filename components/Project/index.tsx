...
export default function Project(props: { project: Project }) {
    ...
    return (
        <div className={style.container}>
            <div className={style['private-source']} style={showPrivate ? {height: '50px'} : {height: '0', padding: '0'}}>
                Private Source
            </div>
            ...
            <div className={style.bottom}>
                <div className={style.row}>
                    ...
                    {props.project.post && <Link className={style.blog} href={props.project.post}>View Blog</Link>}
                </div>
                ...
                <div>
                    ...
                    <Code type='button' className={style.source} size={30} onClick={() => {
                        if(props.project.source == 'private')
                            privateSource();
                        else
                            window.open(props.project.source, '_blank')
                    }}/>
                </div>
